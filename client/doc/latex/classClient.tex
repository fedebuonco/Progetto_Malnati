...
void {\bfseries Sync\+Write\+CM} (\mbox{\hyperlink{classSyncTCPSocket}{Sync\+TCPSocket}} \&stcp, \mbox{\hyperlink{classControlMessage}{Control\+Message}} \&cm)
\item 
\mbox{\Hypertarget{classClient_aa7c88ef1283a8b6dd0d1fe9cc81f8e29}\label{classClient_aa7c88ef1283a8b6dd0d1fe9cc81f8e29}} 
...
\begin{DoxyCompactList}\small\item\em We read until the eof, then we return a \mbox{\hyperlink{classControlMessage}{Control\+Message}} using the buffer we read. \end{DoxyCompactList}\item 
...
std\+::string {\bfseries Hash\+File} (const std\+::filesystem\+::path \&path)
...
\mbox{\hyperlink{structRawEndpoint}{Raw\+Endpoint}} {\bfseries server\+\_\+re\+\_\+}
\item 
...
\mbox{\hyperlink{classWatcher}{Watcher}} {\bfseries watcher\+\_\+}
\end{DoxyCompactItemize}
...
Handles the result by starting the diff computation. \mbox{\Hypertarget{classClient_ad90c29a5ac034afb4d04aae5d58dd60c}\label{classClient_ad90c29a5ac034afb4d04aae5d58dd60c}} 
...
We bind to the callback this, to that when called from the watcher, \char`\"{}this\char`\"{} is defined. \href{https://stackoverflow.com/questions/14189440/c-callback-using-class-member/14189561}{\texttt{ https\+://stackoverflow.\+com/questions/14189440/c-\/callback-\/using-\/class-\/member/14189561}} 
