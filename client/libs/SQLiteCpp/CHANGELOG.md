...
- Added a DatabaseConnection::exec() method to execute simple SQL statement
...
- Added an easy wrapper DatabaseConnection::execAngGet()

Version 0.4.0 - Apr 23 2012
- Added a DatabaseConnection::tableExists() easy to use function
...
- Added DatabaseConnection::createFunction()
...
- DatabaseConnection constructor support opening a database with a custom VFS (default to NULL)
...
- Added Unit Tests
- Added aBusyTimeoutMs parameter to DatabaseConnection() constructors
- Added DatabaseConnection::getTotalChanges()
- Added DatabaseConnection::getErrorCode()
...
- Fixed valgrind error on DatabaseConnection destructor
- Added DatabaseConnection::loadExtension
...
- Added DatabaseConnection::getHandle()
...
- Add DatabaseConnection::VERSION to reach SQLITE_VERSION without including sqlite3.h in application code
...
- Remove Column::errmsg() method : use DatabaseConnection or Statement equivalents
...
- Add a move constructor to DatabaseConnection #157
...
- #211 Implement DatabaseConnection::backup()
...
- Replace DatabaseConnection::backup() "C" implementation by calling the Backup class
